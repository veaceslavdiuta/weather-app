        ...
        <div className={classes.hourlyForecast}>
            ...
            <div className={classes.hoursContainer}>
                {selectedIndex.map((item) => {
                    ...
                    const imgSrc = `https://openweathermap.org/img/wn/${data.weather[0].icon}@4x.png`;

                    return (
                        <div className={classes.hours} key={item} style={{ background: formattedHour >= 6 && formattedHour <= 20 ? secondBackground : firstBackground }}>
